 ...
 */
class ExamenFisicoRepository extends ServiceEntityRepository
{
    ...
    // /**
    //  * @return ExamenFisico[] Returns an array of ExamenFisico objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?ExamenFisico
    {
        return $this->createQueryBuilder('e')
            ->andWhere('e.exampleField = :val')
            ->setParameter('val', $value)
